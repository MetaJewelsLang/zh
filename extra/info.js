const buildmessage=`built at Fri Aug 12 09:47:18 2022 by v1.3.2`
...
const menu=['',[`meta/Meta`,`about/关于`,`guide/使用指南`,`dimensions/层级`,],[`low/底层语法`,`existence/存在性`,`syntaxtree/语法树`,`binding/绑定`,`functions/函数`,],[`guidelines/规范`,`naming/命名规范`,],[`core/内置内容`,`types/类型`,`logics/逻辑`,`forall/任意`,`exists/存在`,`tuples/元组`,`namedtuples/具名元组`,`sets/集合`,],[`base/Base内容`,],[`stdlib/标准库`,`about/关于`,],]

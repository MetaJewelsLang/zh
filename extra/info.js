const buildmessage=`built at Sat Jul 23 14:35:26 2022`
...
const menu=['',[`meta/Meta`,`about/关于`,`guide/使用指南`,`dimensions/层级`,],[`low/底层语法`,`existence/存在性`,`syntaxtree/语法树`,],[`core/内置内容`,`types/类型`,`logics/逻辑`,`forall/任意`,`exists/存在`,`tuples/元组`,`namedtuples/具名元组`,`sets/集合`,],[`base/Base内容`,],[`stdlib/标准库`,`about/关于`,],]
